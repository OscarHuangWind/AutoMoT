"""
Implements the BEV encoder vision backbone.
"""
...
import timm
from mot.modeling.bev_encoder.video_swin_transformer import SwinTransformer3D
import mot.modeling.bev_encoder.bev_encoder_utils as t_u
from mot.modeling.bev_encoder.video_resnet import VideoResNet
import copy


class BEVEncoderBackbone(nn.Module):
  """
  ...
  def fuse_features(self, image_features, lidar_features, layer_idx):
    """
    Perform a BEV encoder feature fusion block using a Transformer module.
